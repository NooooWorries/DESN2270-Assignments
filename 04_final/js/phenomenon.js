...
r = function() {
$('.img-3').attr('src', (window.devicePixelRatio > 1) ? ((window.devicePixelRatio > 2) ? 'images/snip20150803_9-838-838-2880.png' : 'images/snip20150803_9-838-838-1920.png') : 'images/snip20150803_9-838-838-960.png');};
$(window).resize(r);
r();
initMenu($('#menu-1'));
